...
Примечание: Здесь мы запрашиваем все статьи через api/get/react и фильтруем на клиенте. Для оптимизации можно создать отдельный API-роут, например, api/get/react/[title], но для простоты оставим так.
